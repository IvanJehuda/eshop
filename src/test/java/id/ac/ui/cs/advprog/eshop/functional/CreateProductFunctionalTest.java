...
class CreateProductFunctionalTest {
    ...
    @Test
    void createProductemptyNamestaysOnPage(ChromeDriver driver) throws Exception {
        // Navigate to Create Product page
        driver.get(baseUrl + "/product/create");
    ...
    @Test
    void createProductnegativeQuantitystaysOnPage(ChromeDriver driver) throws Exception {
        // Navigate to Create Product page
        driver.get(baseUrl + "/product/create");
    ...
    @Test
    void createProductemptyQuantitystaysOnPage(ChromeDriver driver) throws Exception {
        // Navigate to Create Product page
        driver.get(baseUrl + "/product/create");
